...
// import remarkGfm from 'remark-gfm'; // <-- Is line ko hata diya gaya hai
  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 animate-fade-in">
      ...
      <article>
        ...
        {/* Blog content ko Markdown se HTML mein render karein */}
        <div className="prose prose-invert prose-lg max-w-none prose-p:text-slate-300 prose-headings:text-white prose-a:text-cyan-400 prose-strong:text-white">
          {/* 'remarkPlugins' ko yahan se hata diya gaya hai */}
          <ReactMarkdown>
            {post.content}
          </ReactMarkdown>
        </div>
